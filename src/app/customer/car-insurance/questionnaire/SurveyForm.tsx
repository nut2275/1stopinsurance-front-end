      ...
      <form onSubmit={handleSubmit} className="space-y-10">
        ...
        <div className="p-6 border-l-4 border-green-500 rounded-lg bg-gray-50 shadow-inner">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <CardOption name="coverage" value="basic" label="คุ้มครองเฉพาะอุบัติเหตุ" type="checkbox" checked={answers.coverage.includes('basic')} onChange={handleCheckboxChange} />
          </div>
        </div>
